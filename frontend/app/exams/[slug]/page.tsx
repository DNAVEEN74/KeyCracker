...
import { UploadCloud, FileText, Loader2, ArrowRight, AlertCircle } from 'lucide-react';
                    ...
                    <div className="space-y-12">
                            ...
                            <div className="relative z-10 space-y-8 max-w-3xl">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/5 p-4 border border-white/5">
                                        <p className="text-xs font-black text-rzp-blue uppercase mb-2">Instructions</p>
                                        <p className="text-sm text-white/60">Generate and save the response sheet as a PDF file on your device. Ensure the file is not corrupted or cropped.</p>
                                    </div>
                                    <Link 
                        ...
                        <div className="bg-[#111] border border-white/5 p-10 md:p-16 relative overflow-hidden group hover:border-rzp-blue/30 transition-all border-l-4 border-l-rzp-blue">
                            ...
                            <div className="relative z-10 space-y-8 max-w-3xl">
                                ...
                                <div className="space-y-6">
                                        <p className="text-lg text-secondary-foreground leading-relaxed">
                                            Drop your PDF file into the upload zone to start analyzing.
                                        </p>
                        ...
                        {[
                            {
                                ...
                                a: "Yes. We automatically detect the official marking rules for the specific exam you selected. Your marks are calculated exactly as the board would do it."
                            },
                            {
                                q: "Is it safe to upload my answer sheet?",
                                a: "Absolutely. We only use the PDF to extract your questions and chosen options. Your personal details are completely scrubbed during processing."
                            },
                            {
